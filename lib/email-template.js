...
const PHONE_HREF = "tel:+14087592435";
    ...
    <tr><td align="center">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:640px;background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 8px 28px rgba(24,34,48,.10);">
        ...
        <tr><td style="background:#182230;padding:24px 30px;">
          ...
          <p style="margin:0;">${button(SITE.whatsappHref, "WhatsApp", true)}${button(SITE.smsHref, "SMS", false)}${button(PHONE_HREF, "Llamar", false)}</p>
          <p style="font-size:11px;line-height:18px;margin:9px 0 0;color:#8f9baa;"><a href="${SITE.locations[0].mapsHref}" style="color:#fbbf24;text-decoration:none;">Cómo llegar</a> &nbsp;·&nbsp; <a href="${ORIGIN}" style="color:#fbbf24;text-decoration:none;">Visitar sitio web</a></p>
        </td></tr>
      </table>
