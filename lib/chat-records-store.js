...
import { assistantAskedForName, detectWhatsAppService as detectService, detectWhatsAppServiceState as detectServiceState, isWhatsAppNonNameReply } from "./whatsapp-workflow";
...
function cleanName(value) {
  ...
  if (isWhatsAppNonNameReply(candidate)) return "";
