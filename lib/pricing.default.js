...
export const DEFAULT_PRICING = {
  ...
  tireBrands: [
    ...
    { id: "cooper", name: "Cooper", tier: "economy" },
    { id: "toyo", name: "Toyo", tier: "standard" },
    { id: "yokohama", name: "Yokohama", tier: "standard" },
    { id: "goodyear", name: "Goodyear", tier: "standard" },
    { id: "bridgestone", name: "Bridgestone", tier: "premium" },
    { id: "michelin", name: "Michelin", tier: "premium" },
  ...
  services: [
    ...
    },
    {
      ...
      // quote this one; the shop confirms in person or by phone.
      chatQuotable: false,
    },
  ],
