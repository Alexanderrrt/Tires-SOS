...
export function renderDeterministicEstimate(result, lang) {
  if (lang === "es") {
    return `Según nuestros precios actuales, el estimado es de ${result.lowFormatted} a ${result.highFormatted}. Es solo un estimado; el precio final se confirma en el taller.`;
  }
