...
export function nextWhatsAppBookingQuestion(fields = {}, lang = "en") {
  if (!fields.service) return lang === "es" ? "Claro. ¿Qué servicio necesitas?" : "Of course. What service do you need?";
  if (!fields.vehicle) {
    if (fields.service === "Diagnostic") {
      return lang === "es"
        ? "Entiendo. Lo revisaremos con un diagnóstico. ¿Cuál es el año, la marca y el modelo de tu vehículo?"
        : "Understood. We'll inspect it with a diagnostic. What is your vehicle's year, make, and model?";
    }
