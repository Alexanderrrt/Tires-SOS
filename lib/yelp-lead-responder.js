...
async function processLead(rawEmail) {
  ...
  try {
    await sendGmailEmail({
      ...
      // Yelp turns replies sent to its relay into chat bubbles. HTML templates
      // are flattened there, exposing logo alt text, button labels and footer
      // copy. Deliberately send only the clean customer-facing text.
      text: replyText,
