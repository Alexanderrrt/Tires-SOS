...
import { gmailConfigured, listUnreadYelpLeadEmails, markProcessed, sendGmailReply } from "./gmail-client";
 ...
 * Resend/lib/lead-notify.js is only used as a failure-escalation alert if the
 * Gmail send itself fails.
 *
