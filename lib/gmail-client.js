...
// Validated against a real Yelp lead email: Yelp sends business-message
// notifications (including "Request a Quote" leads and its unreplied-lead
// reminders) from Yelp <reply+...@messaging.yelp.com>, subject
// "Message from <Customer> for <Business Name>" — never from no-reply@yelp.com,
// and with no Request a Quote text in the subject at all. Adjust here if
// Yelp changes their sender/subject format.
const YELP_LEAD_QUERY = 'from:messaging.yelp.com subject:"Tires SOS Rescue" is:unread';
