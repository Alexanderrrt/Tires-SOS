...
// confirmation prompts) are excluded. Adjust here if Yelp changes their
// subject formats or introduces a third one.
const YELP_LEAD_QUERY = 'from:messaging.yelp.com (subject:"for Tires SOS Rescue" OR subject:"New Lead:") is:unread';
