export const LEGAL_PAGES = {
    ...
    sections: [
      {
        ...
        items: {
          en: [
            ...
            "Basic usage data such as pages visited, device type, and approximate location from your network or browser settings.",
      ...
      },
      {
        ...
        items: {
          en: [
            ...
            "To improve the website, keep it secure, and understand what is useful.",
            "To meet legal, safety, and business obligations.",
          ],
          es: [
      ...
      {
        heading: { en: "Sharing and third parties", es: "Compartir y terceros" },
        items: {
          en: [
            "We do not sell personal information.",
            "We may use service providers for hosting, messaging, embeds, maps, and AI chat.",
            "Chat and quote details may be processed by Groq to generate responses and by Google Workspace (Gmail) and the mobile carrier's email-to-SMS gateway to alert the shop team.",
            "Instagram, Google Maps, WhatsApp, Groq, Google Workspace, email providers, and mobile carriers may process information under their own privacy policies.",
          ],
          es: [
            "No vendemos información personal.",
            "Podemos usar proveedores para alojamiento, mensajería, contenido integrado, mapas y chat con IA.",
            "Los datos del chat y de las cotizaciones pueden ser procesados por Groq para generar respuestas y por Google Workspace (Gmail) y la pasarela de correo a SMS del operador móvil para avisar al equipo del taller.",
            "Instagram, Google Maps, WhatsApp, Groq, Google Workspace, proveedores de correo y operadores móviles pueden procesar información según sus propias políticas de privacidad.",
          ],
        },
      },
      {
        ...
        items: {
          en: [
            "We may use browser storage to remember language and admin session state.",
  ...
  terms: {
    ...
    sections: [
      {
        heading: { en: "Website use", es: "Uso del sitio" },
        items: {
          en: [
            "Use the site lawfully and do not try to disrupt, scrape, or abuse it.",
            "Do not submit false, harmful, or unauthorized information.",
      ...
      {
        heading: { en: "Estimates and services", es: "Cotizaciones y servicios" },
        items: {
          en: [
            "Online prices are estimates only unless the shop confirms them in person or in writing.",
            "Final pricing may change after inspection, parts review, labor assessment, or vehicle condition.",
      ...
      },
      {
        ...
        items: {
          en: [
            "Instagram, Google Maps, WhatsApp, Groq, Google Workspace, email providers, and mobile carriers are separate services with their own policies and terms.",
            "We are not responsible for outages, policy changes, or content on third-party services.",
          ],
          es: [
            "Instagram, Google Maps, WhatsApp, Groq, Google Workspace, proveedores de correo y operadores móviles son servicios separados con sus propias políticas y términos.",
      ...
      },
      {
        ...
        items: {
          en: [
            "The site content, branding, and original copy belong to Tires SOS Rescue or its licensors unless stated otherwise.",
            "Do not copy or reuse site materials without permission where applicable.",
          ],
          es: [
            "El contenido, la marca y el texto original del sitio pertenecen a Tires SOS Rescue o a sus licenciantes, salvo que se indique lo contrario.",
            "No copies ni reutilices materiales del sitio sin permiso cuando corresponda.",
          ],
        },
      },
      {
        ...
        items: {
          en: [
            "We may update these terms by posting a new version on the site.",
  ...
  disclaimer: {
    ...
    sections: [
      {
        heading: { en: "Estimates are estimates", es: "Los estimados son estimados" },
        items: {
          en: [
            "Online estimates are rough ranges only and do not replace an in-person inspection.",
      ...
      },
      {
        ...
        items: {
          en: [
            ...
            "Always confirm important service details with the shop before making travel or spending decisions.",
          ],
          es: [
            "Las respuestas del chat y las cotizaciones son solo informativas.",
            "Confirma siempre los detalles importantes con el taller antes de viajar o gastar dinero.",
          ],
        },
      },
      {
