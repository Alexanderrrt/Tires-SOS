...
const COPY = {
  ...
  hint: {
    ...
    es: "Estado en vivo del proveedor de IA del chat. Los numeros vienen directo de los encabezados de limite de Groq.",
  },
  notConfigured: {
    en: "GROQ_API_KEY is not set — the chatbot is disabled.",
    es: "GROQ_API_KEY no esta configurada — el chat esta desactivado.",
  },
  unknown: { en: "No data yet", es: "Sin datos todavia" },
  unknownHint: {
    en: "Nothing has called the API yet in this server session. Click Check now, or send a chat message.",
    es: "Todavia nadie ha llamado a la API en esta sesion del servidor. Haz clic en Verificar ahora, o envia un mensaje de chat.",
  },
  ok: { en: "Good — API is responding", es: "Bien — la API responde" },
  rateLimited: { en: "Rate limited", es: "Limite alcanzado" },
  ...
  lastChecked: { en: "Last checked", es: "Ultima verificacion" },
  ...
  autoNote: {
    ...
    es: "Se actualiza automaticamente cuando un chat de cliente llama a la API. \"Verificar ahora\" envia una prueba minima de 1 token.",
  },
};
