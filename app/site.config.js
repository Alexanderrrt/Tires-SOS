...
export const COPY = {
  ...
  quote: {
    ...
    vehicleBrandLabel: { en: "Brand", es: "Marca" },
    vehicleBrandPlaceholder: { en: "Select brand", es: "Selecciona marca" },
    vehicleModelLabel: { en: "Model", es: "Modelo" },
    vehicleModelPlaceholder: { en: "Select model", es: "Selecciona modelo" },
    vehicleYearLabel: { en: "Year", es: "Año" },
    vehicleYearPlaceholder: { en: "Select year", es: "Selecciona año" },
