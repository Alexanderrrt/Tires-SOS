export const DEFAULT_CHAT_SETTINGS = {
  ...
  quickPrompts: [
    ...
    { en: "How much for brakes on my car?", es: "¿Cuánto cuesta revisar los frenos de mi carro?" },
    { en: "Do you offer financing?", es: "¿Ofrecen financiamiento?" },
  ],
  systemInstructions:
    "For appointments, collect exactly four things in this order: service, vehicle year/make/model, name, and WhatsApp number. Ask for one missing item at a time. Never ask for quantity, tire size, tire brand, oil type, viscosity, trim, engine, or any other technical detail. Keep replies concise, warm, and natural. Once all four required items are present, move directly to available times.",
